...
import { Briefcase, Check, Loader2, User, Eye, EyeOff } from "lucide-react";
import {
  Dialog,
  DialogContent,
  DialogDescription,
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={onSubmit} className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Password {editingUser ? <span className="text-xs text-gray-500"> <br /> (leave blank to keep current)</span> : <span className="text-red-500">*</span>}</label>
                <div className="relative">
                  <input
                    type={showPassword ? "text" : "password"}
                    value={formData.password || ""}
                    onChange={(e) => setFormData((p) => ({ ...p, password: e.target.value }))}
                    placeholder={editingUser ? "Enter new password" : "Enter a password"}
                    className="w-full px-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Confirm Password {editingUser ? <span className="text-xs text-gray-500"> <br /> (leave blank to keep current)</span> : <span className="text-red-500">*</span>}</label>
                <div className="relative">
                  <input
