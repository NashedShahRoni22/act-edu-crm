...
export default function ClientsReportsSkeleton() {
  ...
  return (
    <SectionContainer>
      ...
      <motion.div
        ...
        className="mb-6"
      >
        <div className="h-9 bg-gray-200 rounded-lg w-48 mb-2 animate-pulse" />
            ...
            <tbody>
              {skeletonRows.map((_, rowIndex) => (
                ...
                >
                  ...
                  <td className="px-6 py-4">
                    <div className="h-8 bg-gray-200 rounded-full w-8 mx-auto animate-pulse" />
                  </td>
                  <td className="px-6 py-4">
