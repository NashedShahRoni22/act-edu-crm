...
export default function ContactDocumentsTab({ contactId }) {
  ...
  const { data, isLoading, isError } = useQuery({
    queryKey: [`/contact/${contactId}/documents`, accessToken],
  ...
  const uploadDocumentMutation = useMutation({
    mutationFn: async (file) => {
      ...
      fd.append("file", file);
      return await postWithToken(`/contact/${contactId}/documents`, fd, accessToken);
    },
    onSuccess: (res) => {
        ...
        >
          ...
          <DialogContent className="max-w-md">
            <DialogHeader>
              ...
              <DialogDescription>
                Add a new document for this contact.
              </DialogDescription>
            </DialogHeader>
